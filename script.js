(async () => {
    ...
    const URL = "https://teachablemachine.withgoogle.com/models/jdS4nJW4e/";

    // Hier kun je jouw classes aan geluiden en afbeeldingen koppelen

    const sounds = {
        "verdrietig gezicht ": new Audio("my_sounds/verdrietig.mp3"),
        "bang gezicht ": new Audio("my_sounds/bang.mp3"),
        "donker ": new Audio("my_sounds/donker.mp3"), 
    };

    const images = {
        "verdrietig gezicht ": "my_images/ster.png",
        "bang gezicht ": "my_images/maan.png",
        "donker ": "my_images/nachtlampje.png",
        "Neutral": "my_images/beer.png"
    };
